package com.softedit.inventory.constant;


import static com.softedit.inventory.constant.SecurityConstant.SERVER_CONTEXT_PATH;

public class FileConstant {
    public static final String USER_IMAGE_PATH = "/user/image/";
    public static final String JPG_EXTENSION = "jpg";
    public static final String USER_FOLDER = System.getProperty("user.home") + "/inventory/user/"; // regardless of the user system, it will create the folder in the user home
