...
public class SecurityConstant {
    ...
    public static final String SOFT_EDIT_INC = "Inventory, INC";

    public static final String SOFT_EDIT_ADMINISTRATION = "User Management Portal";
    ...
    public static final String SERVER_CONTEXT_PATH = "http://localhost:8080/api";
